...
(function(){var t="0.2.5",j=window.jQuery||window.$||(window.$={}),f={parse:window.JSON&&(window.JSON.parse||window.JSON.decode)||String.prototype.evalJSON&&function(G){return String(G).evalJSON()}||j.parseJSON||j.evalJSON,stringify:Object.toJSON||window.JSON&&(window.JSON.stringify||window.JSON.encode)||j.toJSON};if(!f.parse||!f.stringify){throw new Error("No JSON support found, include //cdnjs.cloudflare.com/ajax/libs/json2/20110223/json2.js to page")}var m={},c={jStorage:"{}"},z=null,o=0,i=false,k={},E=false,B=0,s={},y=+new Date(),C,A="00000000 77073096 EE0E612C 990951BA 076DC419 706AF48F E963A535 9E6495A3 0EDB8832 79DCB8A4 E0D5E91E 97D2D988 09B64C2B 7EB17CBD E7B82D07 90BF1D91 1DB71064 6AB020F2 F3B97148 84BE41DE 1ADAD47D 6DDDE4EB F4D4B551 83D385C7 136C9856 646BA8C0 FD62F97A 8A65C9EC 14015C4F 63066CD9 FA0F3D63 8D080DF5 3B6E20C8 4C69105E D56041E4 A2677172 3C03E4D1 4B04D447 D20D85FD A50AB56B 35B5A8FA 42B2986C DBBBC9D6 ACBCF940 32D86CE3 45DF5C75 DCD60DCF ABD13D59 26D930AC 51DE003A C8D75180 BFD06116 21B4F4B5 56B3C423 CFBA9599 B8BDA50F 2802B89E 5F058808 C60CD9B2 B10BE924 2F6F7C87 58684C11 C1611DAB B6662D3D 76DC4190 01DB7106 98D220BC EFD5102A 71B18589 06B6B51F 9FBFE4A5 E8B8D433 7807C9A2 0F00F934 9609A88E E10E9818 7F6A0DBB 086D3D2D 91646C97 E6635C01 6B6B51F4 1C6C6162 856530D8 F262004E 6C0695ED 1B01A57B 8208F4C1 F50FC457 65B0D9C6 12B7E950 8BBEB8EA FCB9887C 62DD1DDF 15DA2D49 8CD37CF3 FBD44C65 4DB26158 3AB551CE A3BC0074 D4BB30E2 4ADFA541 3DD895D7 A4D1C46D D3D6F4FB 4369E96A 346ED9FC AD678846 DA60B8D0 44042D73 33031DE5 AA0A4C5F DD0D7CC9 5005713C 270241AA BE0B1010 C90C2086 5768B525 206F85B3 B966D409 CE61E49F 5EDEF90E 29D9C998 B0D09822 C7D7A8B4 59B33D17 2EB40D81 B7BD5C3B C0BA6CAD EDB88320 9ABFB3B6 03B6E20C 74B1D29A EAD54739 9DD277AF 04DB2615 73DC1683 E3630B12 94643B84 0D6D6A3E 7A6A5AA8 E40ECF0B 9309FF9D 0A00AE27 7D079EB1 F00F9344 8708A3D2 1E01F268 6906C2FE F762575D 806567CB 196C3671 6E6B06E7 FED41B76 89D32BE0 10DA7A5A 67DD4ACC F9B9DF6F 8EBEEFF9 17B7BE43 60B08ED5 D6D6A3E8 A1D1937E 38D8C2C4 4FDFF252 D1BB67F1 A6BC5767 3FB506DD 48B2364B D80D2BDA AF0A1B4C 36034AF6 41047A60 DF60EFC3 A867DF55 316E8EEF 4669BE79 CB61B38C BC66831A 256FD2A0 5268E236 CC0C7795 BB0B4703 220216B9 5505262F C5BA3BBE B2BD0B28 2BB45A92 5CB36A04 C2D7FFA7 B5D0CF31 2CD99E8B 5BDEAE1D 9B64C2B0 EC63F226 756AA39C 026D930A 9C0906A9 EB0E363F 72076785 05005713 95BF4A82 E2B87A14 7BB12BAE 0CB61B38 92D28E9B E5D5BE0D 7CDCEFB7 0BDBDF21 86D3D2D4 F1D4E242 68DDB3F8 1FDA836E 81BE16CD F6B9265B 6FB077E1 18B74777 88085AE6 FF0F6A70 66063BCA 11010B5C 8F659EFF F862AE69 616BFFD3 166CCF45 A00AE278 D70DD2EE 4E048354 3903B3C2 A7672661 D06016F7 4969474D 3E6E77DB AED16A4A D9D65ADC 40DF0B66 37D83BF0 A9BCAE53 DEBB9EC5 47B2CF7F 30B5FFE9 BDBDF21C CABAC28A 53B39330 24B4A3A6 BAD03605 CDD70693 54DE5729 23D967BF B3667A2E C4614AB8 5D681B02 2A6F2B94 B40BBE37 C30C8EA1 5A05DF1B 2D02EF8D",D={isXML:function(H){var G=(H?H.ownerDocument||H:0).documentElement;return G?G.nodeName!=="HTML":false},encode:function(H){if(!this.isXML(H)){return false}try{return new XMLSerializer().serializeToString(H)}catch(G){try{return H.xml}catch(I){}}return false},decode:function(H){var G=("DOMParser" in window&&(new DOMParser()).parseFromString)||(window.ActiveXObject&&function(J){var K=new ActiveXObject("Microsoft.XMLDOM");K.async="false";K.loadXML(J);return K}),I;if(!G){return false}I=G.call("DOMParser" in window&&(new DOMParser())||window,H,"text/xml");return this.isXML(I)?I:false}};function q(){var G=false;if("localStorage" in window){try{window.localStorage.setItem("_tmptest","tmpval");G=true;window.localStorage.removeItem("_tmptest")}catch(H){}}if(G){try{if(window.localStorage){c=window.localStorage;i="localStorage";B=c.jStorage_update}}catch(M){}}else{if("globalStorage" in window){try{if(window.globalStorage){c=window.globalStorage[window.location.hostname];i="globalStorage";B=c.jStorage_update}}catch(L){}}else{z=document.createElement("link");if(z.addBehavior){z.style.behavior="url(#default#userData)";document.getElementsByTagName("head")[0].appendChild(z);z.load("jStorage");var K="{}";try{K=z.getAttribute("jStorage")}catch(J){}try{B=z.getAttribute("jStorage_update")}catch(I){}c.jStorage=K;i="userDataBehavior"}else{z=null;return}}}l();b();w();u();if("addEventListener" in window){window.addEventListener("pageshow",function(N){if(N.persisted){p()}},false)}}function e(){var I="{}";if(i=="userDataBehavior"){z.load("jStorage");try{I=z.getAttribute("jStorage")}catch(H){}try{B=z.getAttribute("jStorage_update")}catch(G){}c.jStorage=I}l();b();u()}function w(){if(i=="localStorage"||i=="globalStorage"){if("addEventListener" in window){window.addEventListener("storage",p,false)}else{document.attachEvent("onstorage",p)}}else{if(i=="userDataBehavior"){setInterval(p,1000)}}}function p(){var G;clearTimeout(E);E=setTimeout(function(){if(i=="localStorage"||i=="globalStorage"){G=c.jStorage_update}else{if(i=="userDataBehavior"){z.load("jStorage");try{G=z.getAttribute("jStorage_update")}catch(H){}}}if(G&&G!=B){B=G;h()}},25)}function h(){var G=f.parse(f.stringify(m.__jstorage_meta.CRC32)),K;e();K=f.parse(f.stringify(m.__jstorage_meta.CRC32));var I,H=[],J=[];for(I in G){if(G.hasOwnProperty(I)){if(!K[I]){J.push(I);continue}if(G[I]!=K[I]){H.push(I)}}}for(I in K){if(K.hasOwnProperty(I)){if(!G[I]){H.push(I)}}}F(H,"updated");F(J,"deleted")}function F(L,M){L=[].concat(L||[]);if(M=="flushed"){L=[];for(var K in k){if(k.hasOwnProperty(K)){L.push(K)}}M="deleted"}for(var J=0,G=L.length;J<G;J++){if(k[L[J]]){for(var I=0,H=k[L[J]].length;I<H;I++){k[L[J]][I](L[J],M)}}}}function n(){var G=(+new Date()).toString();if(i=="localStorage"||i=="globalStorage"){c.jStorage_update=G}else{if(i=="userDataBehavior"){z.setAttribute("jStorage_update",G);z.save("jStorage")}}p()}function l(){if(c.jStorage){try{m=f.parse(String(c.jStorage))}catch(G){c.jStorage="{}"}}else{c.jStorage="{}"}o=c.jStorage?String(c.jStorage).length:0;if(!m.__jstorage_meta){m.__jstorage_meta={}}if(!m.__jstorage_meta.CRC32){m.__jstorage_meta.CRC32={}}}function r(){a();try{c.jStorage=f.stringify(m);if(z){z.setAttribute("jStorage",c.jStorage);z.save("jStorage")}o=c.jStorage?String(c.jStorage).length:0}catch(G){}}function v(G){if(!G||(typeof G!="string"&&typeof G!="number")){throw new TypeError("Key name must be string or numeric")}if(G=="__jstorage_meta"){throw new TypeError("Reserved key name")}return true}function b(){var M,H,K,I,J=Infinity,L=false,G=[];clearTimeout(C);if(!m.__jstorage_meta||typeof m.__jstorage_meta.TTL!="object"){return}M=+new Date();K=m.__jstorage_meta.TTL;I=m.__jstorage_meta.CRC32;for(H in K){if(K.hasOwnProperty(H)){if(K[H]<=M){delete K[H];delete I[H];delete m[H];L=true;G.push(H)}else{if(K[H]<J){J=K[H]}}}}if(J!=Infinity){C=setTimeout(b,J-M)}if(L){r();n();F(G,"deleted")}}function u(){if(!m.__jstorage_meta.PubSub){return}var G,I=y;for(var H=len=m.__jstorage_meta.PubSub.length-1;H>=0;H--){G=m.__jstorage_meta.PubSub[H];if(G[0]>y){I=G[0];d(G[1],G[2])}}y=I}function d(I,J){if(s[I]){for(var H=0,G=s[I].length;H<G;H++){s[I][H](I,f.parse(f.stringify(J)))}}}function a(){if(!m.__jstorage_meta.PubSub){return}var I=+new Date()-2000;for(var H=0,G=m.__jstorage_meta.PubSub.length;H<G;H++){if(m.__jstorage_meta.PubSub[H][0]<=I){m.__jstorage_meta.PubSub.splice(H,m.__jstorage_meta.PubSub.length-H);break}}if(!m.__jstorage_meta.PubSub.length){delete m.__jstorage_meta.PubSub}}function g(G,H){if(!m.__jstorage_meta){m.__jstorage_meta={}}if(!m.__jstorage_meta.PubSub){m.__jstorage_meta.PubSub=[]}m.__jstorage_meta.PubSub.unshift([+new Date,G,H]);r();n()}function x(K,J){J=J||0;var L=0,H=0;J=J^(-1);for(var I=0,G=K.length;I<G;I++){L=(J^K.charCodeAt(I))&255;H="0x"+A.substr(L*9,8);J=(J>>>8)^H}return J^(-1)}j.jStorage={version:t,set:function(H,I,G){v(H);G=G||{};if(typeof I=="undefined"){this.deleteKey(H);return I}if(D.isXML(I)){I={_is_xml:true,xml:D.encode(I)}}else{if(typeof I=="function"){return undefined}else{if(I&&typeof I=="object"){I=f.parse(f.stringify(I))}}}m[H]=I;m.__jstorage_meta.CRC32[H]=x(f.stringify(I));this.setTTL(H,G.TTL||0);F(H,"updated");return I},get:function(G,H){v(G);if(G in m){if(m[G]&&typeof m[G]=="object"&&m[G]._is_xml&&m[G]._is_xml){return D.decode(m[G].xml)}else{return m[G]}}return typeof(H)=="undefined"?null:H},deleteKey:function(G){v(G);if(G in m){delete m[G];if(typeof m.__jstorage_meta.TTL=="object"&&G in m.__jstorage_meta.TTL){delete m.__jstorage_meta.TTL[G]}delete m.__jstorage_meta.CRC32[G];r();n();F(G,"deleted");return true}return false},setTTL:function(H,G){var I=+new Date();v(H);G=Number(G)||0;if(H in m){if(!m.__jstorage_meta.TTL){m.__jstorage_meta.TTL={}}if(G>0){m.__jstorage_meta.TTL[H]=I+G}else{delete m.__jstorage_meta.TTL[H]}r();b();n();return true}return false},getTTL:function(H){var I=+new Date(),G;v(H);if(H in m&&m.__jstorage_meta.TTL&&m.__jstorage_meta.TTL[H]){G=m.__jstorage_meta.TTL[H]-I;return G||0}return 0},flush:function(){m={__jstorage_meta:{CRC32:{}}};r();n();F(null,"flushed");return true},storageObj:function(){function G(){}G.prototype=m;return new G()},index:function(){var G=[],H;for(H in m){if(m.hasOwnProperty(H)&&H!="__jstorage_meta"){G.push(H)}}return G},storageSize:function(){return o},currentBackend:function(){return i},storageAvailable:function(){return !!i},listenKeyChange:function(G,H){v(G);if(!k[G]){k[G]=[]}k[G].push(H)},stopListening:function(H,I){v(H);if(!k[H]){return}if(!I){delete k[H];return}for(var G=k[H].length-1;G>=0;G--){if(k[H][G]==I){k[H].splice(G,1)}}},subscribe:function(G,H){G=(G||"").toString();if(!G){throw new TypeError("Channel not defined")}if(!s[G]){s[G]=[]}s[G].push(H)},publish:function(G,H){G=(G||"").toString();if(!G){throw new TypeError("Channel not defined")}g(G,H)},reInit:function(){e()}};q()})();

function murmurhash3_32_gc(k,f){var l,m,h,b,e,a,c,j,g,d;l=k.length&3;m=k.length-l;h=f;e=3432918353;c=461845907;d=0;while(d<m){g=((k.charCodeAt(d)&255))|((k.charCodeAt(++d)&255)<<8)|((k.charCodeAt(++d)&255)<<16)|((k.charCodeAt(++d)&255)<<24);++d;g=((((g&65535)*e)+((((g>>>16)*e)&65535)<<16)))&4294967295;g=(g<<15)|(g>>>17);g=((((g&65535)*c)+((((g>>>16)*c)&65535)<<16)))&4294967295;h^=g;h=(h<<13)|(h>>>19);b=((((h&65535)*5)+((((h>>>16)*5)&65535)<<16)))&4294967295;h=(((b&65535)+27492)+((((b>>>16)+58964)&65535)<<16))}g=0;switch(l){case 3:g^=(k.charCodeAt(d+2)&255)<<16;case 2:g^=(k.charCodeAt(d+1)&255)<<8;case 1:g^=(k.charCodeAt(d)&255);g=(((g&65535)*e)+((((g>>>16)*e)&65535)<<16))&4294967295;g=(g<<15)|(g>>>17);g=(((g&65535)*c)+((((g>>>16)*c)&65535)<<16))&4294967295;h^=g}h^=k.length;h^=h>>>16;h=(((h&65535)*2246822507)+((((h>>>16)*2246822507)&65535)<<16))&4294967295;h^=h>>>13;h=((((h&65535)*3266489909)+((((h>>>16)*3266489909)&65535)<<16)))&4294967295;h^=h>>>16;return h>>>0};

/*! WookBar by Seon-Wook Park (www.swook.net) | CC BY-NC-SA | util.js */(function(e,t,n){function i(e){e||(e=document.URL);if(e in r)return r[e];var n=e==document.URL?document.location:t('<a href="'+e+'"/>')[0],i={protocol:n.protocol.slice(0,n.protocol.length-1),host:n.hostname,port:n.port,path:n.pathname,query:n.search,params:n.search.length?function(){var e=[],r={};return t.each(n.search.slice(1).split("&"),function(t,n){n.length&&(e=n.split("="),e[1].length&&(r[e[0]]=e[1]))}),r}():"",file:n.pathname.match(/\/([^\/?&]*)[^\/]*$/)[1],hash:n.hash.length?n.hash.slice(1):"",relative:n.href.match(/:\/\/[^\/]+(.*)$/)[1],full:n.href.match(/([^#]*)/)[1],full_hash:n.href};return e==n.href&&(r[e]=i),n instanceof jQuery&&n.remove(),i}function o(e,r){var i,o=murmurhash3_32_gc(this.toString()+e.toString());t.each(s,function(e,t){if(t.func==o)return i=t,!1});var u=setTimeout(e,r,[].splice.call(arguments,2));i!=n?(clearTimeout(i.timeout),i.timeout=u):s.push({func:o,timeout:u})}function u(e){var n=murmurhash3_32_gc(this.toString()+e.toString());t.each(s,function(e,t){if(t.func==n)return clearTimeout(t.timeout),!1})}var r={},s=[];e.util={parseURL:i,setDelay:o,clearDelay:u}})(window.WB=window.WB||{},jQuery);

/*! WookBar by Seon-Wook Park (www.swook.net) | CC BY-NC-SA | appmenu.js */(function(e,t,n){var r=e.UI,i=e.data,s=e.elem.appmenu,o=e.util;s.blogger=t("a.blogger",s.main);var u=function(){f.attachAll()},a={main:{focus:function(){s.main.addClass("hover"),o.clearDelay(a.main.blur)},blur:function(){s.main.removeClass("hover"),o.clearDelay(a.main.blur)}}},f={attachAll:function(){s.main.hover(f.main.hoverIn,f.main.hoverOut),t("html").click(f.body.click)},body:{click:function(e){a.main.blur()}},main:{hoverIn:function(e){a.main.focus()},hoverOut:function(e){o.setDelay(a.main.blur,1e3)}}};u()})(window.WB=window.WB||{},jQuery);

/*! WookBar by Seon-Wook Park (www.swook.net) | CC BY-NC-SA | search.js */(function(e,t,n){var r=e.UI,i=e.data,s=e.elem.search,o=e.util;s.submit=t("input[type=submit]",s.form),s.results=t("div.results",s.main);var u=function(){f.attachAll()},a={input:{focus:function(){s.input.focus()},blur:function(){s.input.blur()}}},f={attachAll:function(){s.main.hover(f.main.hoverIn,f.main.hoverOut),s.input.on("focus",f.input.focus).on("blur",f.input.blur),t(window).resize(f.window.resize),f.window.resize()},window:{resize:function(e){s.results.css("max-height",window.innerHeight-26)}},main:{hoverIn:function(e){o.clearDelay(a.input.blur),a.input.focus()},hoverOut:function(e){s.input.is(":focus")?o.setDelay(a.input.blur,3e3):a.input.blur()}},input:{focus:function(e){s.main.addClass("focus")},blur:function(e){s.main.removeClass("focus")}},submit:{submit:function(e){e.preventDefault()}}};u()})(window.WB=window.WB||{},jQuery);
...
(function(g){var m="UndefinedTemplateError",h="TemplateCompilationError",l="TemplateExecutionError";var a="[object Array]",e="[object String]",b="[object Function]";var d=1,o="%",k=/^[^<]*(<[\w\W]+>)[^>]*$/,j=Object.prototype.toString;function c(n,p){throw (g.extend(n,p),n)}function f(r){var q=[];if(j.call(r)!==a){return false}for(var p=0,n=r.length;p<n;p++){q[p]=r[p].jqote_id}return q.length?q.sort().join(".").replace(/(\b\d+\b)\.(?:\1(\.|$))+/g,"$1$2"):false}function i(p,r){var v,u=[],r=r||o,s=j.call(p);if(s===b){return p.jqote_id?[p]:false}if(s!==a){return[g.jqotec(p,r)]}if(s===a){for(var q=0,n=p.length;q<n;q++){if(v=i(p[q],r)){u.push(v[0])}}}return u.length?u:false}g.fn.extend({jqote:function(p,n){var p=j.call(p)===a?p:[p],q="";this.each(function(s){var t=g.jqotec(this,n);for(var r=0;r<p.length;r++){q+=t.call(p[r],s,r,p,t)}});return q}});g.each({app:"append",pre:"prepend",sub:"html"},function(n,p){g.fn["jqote"+n]=function(u,w,r){var s,v,x=g.jqote(u,w,r),q=!k.test(x)?function(t){return g(document.createTextNode(t))}:g;if(!!(s=f(i(u)))){v=new RegExp("(^|\\.)"+s.split(".").join("\\.(.*)?")+"(\\.|$)")}return this.each(function(){var t=q(x);g(this)[p](t);(t[0].nodeType===3?g(this):t).trigger("jqote."+n,[t,v])})}});g.extend({jqote:function(u,v,r){var w="",r=r||o,s=i(u,r);if(s===false){c(new Error("Empty or undefined template passed to $.jqote"),{type:m})}v=j.call(v)!==a?[v]:v;for(var q=0,n=s.length;q<n;q++){for(var p=0;p<v.length;p++){w+=s[q].call(v[p],q,p,v,s[q])}}return w},jqotec:function(A,B){var n,q,z,B=B||o,x=j.call(A);if(x===e&&k.test(A)){q=z=A;if(n=g.jqotecache[A]){return n}}else{q=x===e||A.nodeType?g(A):A instanceof jQuery?A:null;if(!q[0]||!(z=q[0].innerHTML)&&!(z=q.text())){c(new Error("Empty or undefined template passed to $.jqotec"),{type:m})}if(n=g.jqotecache[g.data(q[0],"jqote_id")]){return n}}var w="",u,s=z.replace(/\s*<!\[CDATA\[\s*|\s*\]\]>\s*|[\r\n\t]/g,"").split("<"+B).join(B+">\x1b").split(B+">");for(var p=0,r=s.length;p<r;p++){w+=s[p].charAt(0)!=="\x1b"?"out+='"+s[p].replace(/(\\|["'])/g,"\\$1")+"'":(s[p].charAt(1)==="="?";out+=("+s[p].substr(2)+");":(s[p].charAt(1)==="!"?";out+=$.jqotenc(("+s[p].substr(2)+"));":";"+s[p].substr(1)))}w="try{"+('var out="";'+w+";return out;").split("out+='';").join("").split('var out="";out+=').join("var out=")+'}catch(e){e.type="'+l+'";e.args=arguments;e.template=arguments.callee.toString();throw e;}';try{var y=new Function("i, j, data, fn",w)}catch(v){c(v,{type:h})}u=q instanceof jQuery?g.data(q[0],"jqote_id",d):q;return g.jqotecache[u]=(y.jqote_id=d++,y)},jqotefn:function(q){var p=j.call(q),n=p===e&&k.test(q)?q:g.data(g(q)[0],"jqote_id");return g.jqotecache[n]||false},jqotetag:function(n){if(j.call(n)===e){o=n}},jqotenc:function(n){return n.toString().replace(/&(?!\w+;)/g,"&#38;").split("<").join("&#60;").split(">").join("&#62;").split('"').join("&#34;").split("'").join("&#39;")},jqotecache:{}});g.event.special.jqote={add:function(r){var p,n=r.handler,q=!r.data?[]:j.call(r.data)!==a?[r.data]:r.data;if(!r.namespace){r.namespace="app.pre.sub"}if(!q.length||!(p=f(i(q)))){return}r.handler=function(s,u,t){return !t||t.test(p)?n.apply(this,[s,u]):null}}}})(jQuery);

/*! WookBar by Seon-Wook Park (www.swook.net) | CC BY-NC-SA | ajaxify.js */(function(e,t,n){var r=e.UI,i=e.data,s=e.elem,o=e.util;t.Ajaxify.parseUri=o.parseURL})(window.WB=window.WB||{},jQuery);
